 ...
 */
public class soft252ReferalView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) { //main function
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(soft252ReferalView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
